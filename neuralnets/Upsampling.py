...
sys.path.append("/home/geesara/tensorflow/models/slim")
from datasets import imagenet

from neuralnets import vgg
from neuralnets.vgg_preprocessing import (_mean_image_subtraction,
                                             _R_MEAN, _G_MEAN, _B_MEAN)
os.environ["CUDA_VISIBLE_DEVICES"] = '0'
# A place where you have downloaded a network checkpoint -- look at the previous post
checkpoints_dir = '/home/geesara/checkpoints/voo'
